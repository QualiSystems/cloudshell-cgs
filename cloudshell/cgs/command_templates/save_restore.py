...
ERROR_MAP = OrderedDict(
    [("[Ee]rror:", "An error occurred while executing a CLI command")]
)
...
DELETE_LOCAL_CONFIG_FILE = CommandTemplate(
    "system config-files delete local-file {config_file}", error_map=ERROR_MAP
)
