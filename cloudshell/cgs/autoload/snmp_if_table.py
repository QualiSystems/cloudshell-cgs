...
from cloudshell.cgs.autoload.snmp_if_port_channel_entity import SnmpIfPortChannelEntity
from cloudshell.cgs.autoload.snmp_if_port_entity import SnmpIfPortEntity
from cloudshell.cgs.autoload.snmp_port_attr_tables import SnmpPortAttrTables
