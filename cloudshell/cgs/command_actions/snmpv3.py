...
from cloudshell.cgs.command_templates import snmpv3
...
class SnmpV3Actions(object):
    ...
    def add_snmp_user_auth_and_priv(
        self,
        snmp_password,
        snmp_priv_key,
        snmp_auth_proto,
        ...
        if snmp_auth_proto != SNMPV3Parameters.AUTH_NO_AUTH:
            output += CommandTemplateExecutor(
                ...
                snmp_auth_proto=auth_command_template, snmp_password=snmp_password
            )
        ...
        if snmp_priv_proto != SNMPV3Parameters.PRIV_NO_PRIV:
            output += CommandTemplateExecutor(
                ...
                snmp_priv_proto=priv_command_template, snmp_priv_key=snmp_priv_key
            )
