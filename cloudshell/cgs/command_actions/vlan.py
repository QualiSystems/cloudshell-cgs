...
from cloudshell.cgs.command_actions.filters import FiltersActions
from cloudshell.cgs.command_templates import vlan as vlan_tmpl
...
class VlanActions(FiltersActions):
    ...
    def add_access_vlan_filter(self, vlan, port, action_map=None, error_map=None):
        ...
        return CommandTemplateExecutor(
            ...
            name=self.VLAN_FILTER_NAME_TPL.format(vlan), vlan=vlan, port=port
        )
